...
@else
<p class="text-muted mb-4">参加するには、次の画面でアカウントのパスワードを設定してください。</p>
<a class="btn btn-primary btn-lg w-100" href="{{ route('invitations.password', $token) }}">パスワードを設定して参加</a>
@endif
</section></div>
@endsection
